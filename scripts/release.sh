...
declare -a platforms=("i686-unknown-linux-gnu" "x86_64-unknown-linux-gnu" "arm-unknown-linux-gnueabi" "arm-unknown-linux-gnueabihf" "aarch64-unknown-linux-gnu" "x86_64-apple-darwin" "aarch64-apple-darwin" "i686-pc-windows-gnu" "x86_64-pc-windows-gnu" "aarch64-linux-android" "armv7-linux-androideabi" "i686-linux-android" "x86_64-linux-android" "x86_64-unknown-linux-musl" "s390x-unknown-linux-gnu" "aarch64-apple-ios x86_64-apple-ios" )
